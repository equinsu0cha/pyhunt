...
class CMDEXEC:
    def __init__(self, username='', password='', domain='', hashes=None, aesKey=None,
                 doKerberos=None, kdcHost=None, mode=None, share=None, port=445, scanObject=None):
...
#                    print('sleeping...sharing_violation')
#                    time.sleep(1)
#                    pass
#                elif str(e).find('Broken') >= 0:
#                    # The SMB Connection might have timed out, let's try reconnecting
#                    logging.debug('Connection broken, trying to recreate it')
#                    self.transferClient.reconnect()
...
#        self.transferClient.deleteFile(self.__share, self.__output)
    ...
    def do_get(self, src_path):
        try:
           import ntpath
           newPath = ntpath.normpath(ntpath.join("C:\\windows\\system32", src_path))
